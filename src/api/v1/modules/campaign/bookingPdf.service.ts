...
function drawBpaLogo(doc: InstanceType<typeof PDFDocument>, x: number, y: number) {
  ...
  doc.text("Furtail", x, y + 16, { width: 48, align: "center" });
  doc.restore();
...
export async function generateBookingConfirmationPdfBuffer(
  ...
  return new Promise((resolve, reject) => {
    ...
    drawSectionTitle(doc, "Contact Furtail");
    ...
    doc.text("Generated by Furtail Vaccination System", 48, footerY, {
      align: "center",
      width: contentWidth,
    });
    ...
    doc.text("Official Furtail Vaccination Campaign 2026", 48, footerY + 24, {
      align: "center",
      width: contentWidth,
    });
...
export function bookingPdfFilename(bookingRef: string): string {
  ...
  return `Furtail-Booking-${safe || "booking"}.pdf`;
}
