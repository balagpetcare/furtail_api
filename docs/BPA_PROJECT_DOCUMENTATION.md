# 🐾 Furtail (Furtail) - Project Documentation
...
* **Furtail সোশ্যাল:** পেট ওনাররা তাদের পোষা প্রাণীর ছবি ও অভিজ্ঞতা শেয়ার করবেন।
...
* **Furtail ওনার্স কার্ড:** এটি একটি প্রিমিয়াম সাবস্ক্রিপশন কার্ড। এটি থাকলে প্রতিটি সার্ভিসে বা কেনাকাটায় বিশেষ ডিসকাউন্ট পাওয়া যাবে।
* **লিডারবোর্ড ও পয়েন্ট:** অ্যাপে সক্রিয় থাকা বা কেনাকাটা করলে 'Furtail Coins' জমা হবে। এই কয়েন দিয়ে পরবর্তীতে ফ্রি চেকআপ বা গিফট পাওয়া যাবে।
...
## ৮. Furtail Standards & Principles
...
* **Admin (Furtail):** Platform Control করেন
